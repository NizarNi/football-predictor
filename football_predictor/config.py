...
ODDS_INVALID_KEY_TTL_DAYS = int(os.environ.get("ODDS_INVALID_KEY_TTL_DAYS", 32))
...
# =============================================================================
# TEAM NAME MAPPINGS
# Centralized team name mappings for different data sources
# Each data source (ClubElo, FBref) uses different canonical team names
# =============================================================================
